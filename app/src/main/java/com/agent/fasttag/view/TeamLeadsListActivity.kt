...
class TeamLeadsListActivity : AppCompatActivity() {
    ...
    private fun initView(){
        ...
        binding.headerLayout.tvToolbarHederTitle.text=getString(R.string.team_lead)
    ...
    private fun setupViewModel() {
        ...
        var requestData= GetAgentsByIdRequestJson("00000000-0000-0000-0000-000000000000",fasTagPref.USER_agentID!!)
    ...
    private fun setUpObserver() {
        viewModel.getAllTeamLeadsRequest().observe(this) { it ->
                ...
                Status.SUCCESS -> {
                    ...
                    if(it.data!!.reponseData.size>0) {
                        teamLeadsListAdapter = TeamLeadsListAdapter(teamLeadsListDataList) {
                            AppConstants.parentId = it.agentId
                            var i = Intent(this, AgentsListActivity::class.java)
                            startActivity(i)
                            AppConstants.slideToRightAnim(this)
                            i.putExtra(getString(R.string.login_from), getString(R.string.agent))
